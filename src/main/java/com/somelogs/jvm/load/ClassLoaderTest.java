...
public class ClassLoaderTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Object obj = classLoader.loadClass("com.somelogs.jvm.load.ClassLoaderTest").newInstance();
        System.out.println("class=" + obj.getClass());
        System.out.println(obj instanceof com.somelogs.jvm.load.ClassLoaderTest);
    }
